...
func (s I_d2l)Stroke(ctx *runtime.Context) error {
	...
	ctx.CurrentFrame.PushFrame(types.Jlong(value.(types.Jdouble)))
	return nil
}

func (s I_d2l)Test(octx *runtime.Context) *runtime.Context {
	f := new(runtime.Frame)
...
======================================================================================
						||
						||
						||		d2l 指令执行了窄化类型转换(Narrowing Primitive Conversion，JLS3 §5.1.3)，它可能会导致 value’的数值大小和精度发生丢失。
		注意				||
						||
						||
						||
